...
const Todo = () => {
  ...
  return (
    <div className="container mx-auto p-6">
      <h1 className="text-center text-4xl font-bold text-gray-800 mb-8 py-5">TODO Application</h1>
          ...
          <div className="bg-black rounded-t-lg text-white flex justify-between p-4">
            ...
            <div className="relative z-0 group">
              <input
                ...
                value={searchTerm}
                type="text"
                className="block py-2.5 px-0 w-full text-lg text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-400 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                placeholder=" "
                required
              />
